import{S as e}from"./index-ZTqclg7h.js";import"./packingFunctions-DJWdtK2X.js";import"./clipPlaneFragment-CG7-53_i.js";import"./index-C0lBYtzV.js";import"./vendor-vue-Bt897R15.js";import"./vendor-primevue-CIbVuvmJ.js";const r="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=S);const i="shadowMapFragment",s=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=s);const a="shadowMapPixelShader",n=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=n);const c={name:a,shader:n};export{c as shadowMapPixelShaderWGSL};
