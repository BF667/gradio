import{aq as be,bb as pt,h as Pt,bY as Nt,S as N,a9 as Wt,x as Vt,y as Zt,z as jt,K as Xt,X as Gt,Y as $t,b1 as _t,a2 as qt,a4 as Kt,a6 as Jt,e as mt,ac as Qt,J as q,R as Lt,bZ as Yt,b_ as es,l as Ie,V as T,m as Ne,M as Ce,b$ as ts,c as J,L as de,c0 as He,c1 as ke,c2 as ss,aO as $,c3 as rs,ah as ne,b9 as L,ao as ns,C as Se,ai as he,bA as re,B as os,c4 as Re,d as is,ax as as}from"./index-fhkBm_-l.js";import{af as ye}from"./index-EvByIPOY.js";import{ShaderMaterial as xt}from"./shaderMaterial-C4aCcXdg.js";import"./clipPlaneFragment-vIPxlZzI.js";import"./logDepthDeclaration-Zw7wr5cr.js";import"./fogFragment-B3n5Zb1_.js";import"./sceneUboDeclaration-AVdVQGLb.js";import"./meshUboDeclaration-BkoWoNEZ.js";import"./clipPlaneVertex-BefkYnZz.js";import"./logDepthVertex-C06uQbJ_.js";import"./helperFunctions-B2ihBp_A.js";import"./clipPlaneFragment-hmevHD9w.js";import"./logDepthDeclaration-xEt2Gtn3.js";import"./fogFragment-2JzadA_1.js";import"./sceneUboDeclaration-DyTDhFzr.js";import"./meshUboDeclaration-DZkCLGQW.js";import"./helperFunctions-q5-1FJge.js";import"./clipPlaneVertex-D8fROw7R.js";import"./logDepthVertex-DHOx5WVE.js";import{R as we}from"./rawTexture-DvhWlkMf.js";import"./thinInstanceMesh-BSmszMZS.js";import{A as cs}from"./assetContainer-BrNRCtXa.js";import{Ray as ls}from"./ray-BtaI2Lxe.js";import{S as hs}from"./standardMaterial-3rDu8O-H.js";import"./vendor-vue-Bt897R15.js";import"./vendor-primevue-CIbVuvmJ.js";class fs{constructor(){this.mm=new Map}get(e,t){const s=this.mm.get(e);if(s!==void 0)return s.get(t)}set(e,t,s){let o=this.mm.get(e);o===void 0&&this.mm.set(e,o=new Map),o.set(t,s)}}class us{get standalone(){return this._options?.standalone??!1}get baseMaterial(){return this._baseMaterial}get doNotInjectCode(){return this._options?.doNotInjectCode??!1}constructor(e,t,s){this._baseMaterial=e,this._scene=t??be.LastCreatedScene,this._options=s,this._subMeshToEffect=new Map,this._subMeshToDepthWrapper=new fs,this._meshes=new Map,this._onEffectCreatedObserver=this._baseMaterial.onEffectCreatedObservable.add(o=>{const n=o.subMesh?.getMesh();n&&!this._meshes.has(n)&&this._meshes.set(n,n.onDisposeObservable.add(i=>{const l=this._subMeshToEffect.keys();for(let h=l.next();h.done!==!0;h=l.next()){const a=h.value;a?.getMesh()===i&&(this._subMeshToEffect.delete(a),this._deleteDepthWrapperEffect(a))}})),this._subMeshToEffect.get(o.subMesh)?.[0]!==o.effect&&(this._subMeshToEffect.set(o.subMesh,[o.effect,this._scene.getEngine().currentRenderPassId]),this._deleteDepthWrapperEffect(o.subMesh))})}_deleteDepthWrapperEffect(e){const t=this._subMeshToDepthWrapper.mm.get(e);t&&(t.forEach(s=>{s.mainDrawWrapper.effect?.dispose()}),this._subMeshToDepthWrapper.mm.delete(e))}getEffect(e,t,s){const o=this._subMeshToDepthWrapper.mm.get(e)?.get(t);if(!o)return null;let n=o.drawWrapper[s];return n||(n=o.drawWrapper[s]=new pt(this._scene.getEngine()),n.setEffect(o.mainDrawWrapper.effect,o.mainDrawWrapper.defines)),n}isReadyForSubMesh(e,t,s,o,n){return this.standalone&&!this._baseMaterial.isReadyForSubMesh(e.getMesh(),e,o)?!1:this._makeEffect(e,t,s,n)?.isReady()??!1}dispose(){this._baseMaterial.onEffectCreatedObservable.remove(this._onEffectCreatedObserver),this._onEffectCreatedObserver=null;const e=this._meshes.entries();for(let t=e.next();t.done!==!0;t=e.next()){const[s,o]=t.value;s.onDisposeObservable.remove(o)}}_makeEffect(e,t,s,o){const n=this._scene.getEngine(),i=this._subMeshToEffect.get(e);if(!i)return null;const[l,h]=i;if(!l.isReady())return null;let a=this._subMeshToDepthWrapper.get(e,s);if(!a){const m=new pt(n);m.defines=e._getDrawWrapper(h)?.defines??null,a={drawWrapper:[],mainDrawWrapper:m,depthDefines:"",token:Pt()},a.drawWrapper[o]=m,this._subMeshToDepthWrapper.set(e,s,a)}const _=t.join(`
...
`,x&&(p=p.replace(/}\s*$/g,x+"}")),u.push("biasAndScaleSM","depthValuesSM","lightDataSM","softTransparentShadowSM")}a.mainDrawWrapper.effect=n.createEffect({vertexSource:f,fragmentSource:p,vertexToken:a.token,fragmentToken:a.token},{attributes:l.getAttributesNames(),uniformsNames:u,uniformBuffersNames:l.getUniformBuffersNames(),samplers:l.getSamplers(),defines:_+`
`+l.defines.replace("#define SHADOWS","").replace(/#define SHADOW\d/g,""),indexParameters:l.getIndexParameters(),shaderLanguage:l.shaderLanguage},n);for(let m=0;m<a.drawWrapper.length;++m)m!==o&&a.drawWrapper[m]?.setEffect(a.mainDrawWrapper.effect,a.mainDrawWrapper.defines);return a.mainDrawWrapper.effect}}const vt="gaussianSplattingFragmentDeclaration",ds=`vec4 gaussianColor(vec4 inColor)
