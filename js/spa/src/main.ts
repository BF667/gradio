...
// PrimeVue: Register components as Web Components for use in Svelte
// In PrimeVue v4, styles are injected at runtime via the PrimeVue plugin config
// (Aura theme preset), so no static CSS import is needed.
import { registerCorePrimeVueComponents } from "@gradio/primevue-bridge/components";
//@ts-ignore
...
// Register PrimeVue core components as Web Components
// These become available as <primevue-button>, <primevue-inputtext>, etc.
registerCorePrimeVueComponents();
